...
Einstein's theory of General Relativity has been the dominant theory of gravity for a century. Many of its signature outcomes, such as light-bending, orbital precession, and gravitational waves, have been confirmed by precision tests from both astronomy and cosmology. One last pending test is the gravitational rotation of polarizations. Indeed, since gravity directly affects the spacetime geometry, not only the paths of light can be bent.  Polarizations, often thought as ``internal'' degrees of freedom of the light ray, cannot escape the influence of gravity either.
