...
For parameters of PSR J0737-3039 with a polarized fraction of about
50\% \cite{2004ApJ...615L.137D}, raw thermal sensivity requires a
signal-to-noise of at least $10^7$ in polarization.  For a pulsar
self-noise dominated telescope such as FAST or SKA with a band width
of $\sim 1$ GHz, requires $10^6$ seconds of on target on-pulse
integration to achieve a $5-\sigma$ detection, a substantial
commitment of resources.  Practical considerations include the
limitation that any given object can be only seen for a limited about
of time each day, which for FAST could be short at the low declination
of PSR J0737-3039, making the SKA a more suitable facility. At a duty
cycle of about 20\%, this requires of order a year of observations
with the full phase 2 telesope.  During superior conjunction, the
companion's magnetosphere partially absorbs the pulsar, and plasma
faraday effects may also complicate the analysis.  The pulsar is
likely to be monitored extensively for other reasons, potentially
resulting in a detection over decades of SKA operations.  Similarly,
other more optimal systems may be discovered, for example pulsar-black
hole systems.  Our estimates indicates that this effect is in
principle observable in the foreseeable future.  The calculations in
this paper compute the observable swing in polarization angle from the
gravitational faraday effect of the system orbital angular momentum,
which was not previously understood.  The gravitational
Faraday effect can be added to the wishlist of pulsar tests of general
relativity.
